...
<div class="ui secondary menu">
    <div class="menu full-width">
        <div class="item float-left" style="padding-left: 0px;">
            <h1 style="font-weight: normal">Edit Halaman</h1>
        </div>
    </div>
</div>
...
<div class="ui card full-width">
    <div class="content">
        {!! form()->bind($page)->put(route('page.update', $page->getKey()))->multipart() !!}
        <div class="field required">
            <label>Kategori</label>
            <div class="ui dropdown search selection">
                <select name="category_id" id="category_id" required="required" class="noselection" data-value="1">
        ...
        <div class="field required field-title">
            ...
            <input type="text" id="input_title" name="title" value="{{ old('title', $page->title) }}" required="required" maxlength="191">
        </div>

        <div class="field field-icon upload-field" hidden>
            <label>Gambar</label>
            <div class="fileuploader">
                <input type="file" name="uploads" id="icon_image" data-fileuploader-files="{{ $page->files }}">
            </div>
        ...
        <div class="field field-url" hidden>
            ...
            <input type="text" pattern="^(http:\/\/|https:\/\/).[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$"
                   title="https://test.com" name="description" value="{{ old('description', $page->description) }}"
        ...
        <div class="field field-cover upload-field" hidden>
            ...
            <div class="fileuploader">
                <input type="file" name="uploads" id="cover_image" data-fileuploader-files="{{ $page->files }}">
            </div>
            <span><small><i>Ukuran maksimal file : 2 MB. Format File : jpeg/jpg, png</i></small></span>
        </div>
        ...
        <div class="field required field-thumbnail upload-field" hidden>
            <label>Foto</label>
            <div class="fileuploader">
                <input type="file" name="uploads" id="gallery_dropzone" data-fileuploader-files="{{ $page->files }}">
            </div>
